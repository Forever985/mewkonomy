export default {
  ...
  "Earrings": "耳环",
  "Back": "背部",
  "工匠茶：装备要求等级+5（动作速度将降低）": "工匠茶：裝備要求等級+5（動作速度將降低）",
  "Off Hand": "副手",
  "Pouch": "袋子",
  ...
  // 開源公告
  "开源公告": "MewKonomy 現已完全開源！歡迎 Star、Fork 和參與貢獻。",
  "关闭": "關閉",
  ...
  "护符转化盈利": "護符轉化盈利",
  "冲泡护符转化盈利": "沖泡護符轉化盈利",
  "冲泡精华→冲泡护符→转化，双口径对比理想价格与实际价格": "沖泡精華→沖泡護符→轉化，雙口徑對比理想價格與實際價格",
  "理想价格": "理想價格",
  "实际价格": "實際價格",
  "市场无人买卖时由你主宰，挂价上限=精华直接制作成本": "市場無人買賣時由你主宰，掛價上限=精華直接製作成本",
  "护符档位": "護符檔位",
  "所需精华": "所需精華",
  "精华成本": "精華成本",
  "成功率": "成功率",
  ...
  "理想利润率": "理想利潤率",
  "提示": "提示",
  "实际价格为当前市场成交价，无流动性护符按0计；理想价格为无市场时按精华直接制作成本挂价，点击行查看产出明细": "實際價格為當前市場成交價，無流動性護符按0計；理想價格為無市場時按精華直接製作成本掛價，點擊行查看產出明細",
  "产出明细": "產出明細",
  "转化": "轉化",
  "每档10种护符各10%产出": "每檔10種護符各10%產出",
  "产出护符": "產出護符",
  "掉率": "掉率",
  "市场买价": "市場買價",
  "实际卖价": "實際賣價",
  ...
  // 市場監控
  "市场监控": "市場監控",
  "监控各物品市场成交量与成交额，按成交量实时排行": "監控各物品市場成交量與成交額，按成交量即時排行",
  "市场物品": "市場物品",
  "有成交": "有成交",
  "成交量最高": "成交量最高",
  "数据时间": "資料時間",
  ...
  "线上历史": "線上歷史",
  "最近采样": "最近採樣",
  "本地采样已是最新，无需重复记录": "本地採樣已是最新，無需重複記錄",
  "已记录历史采样点": "已記錄歷史採樣點",
  "正在加载历史分片…": "正在載入歷史分片…",
  // 强化练级页的「生效中筛选」提示条（该页其余词条 zh-tw 本就缺、会回落简体，属既有缺口）
  "已筛选": "已篩選",
  "命中 {0} 条": "命中 {0} 條",
  // 原先只有 en 定义了这个键，中文两种语言下会直接显示键名本身，这里补齐
  "无线上历史提示": "尚未取到線上歷史分片（data/market_history_*.json）。歸檔由 GitHub Actions 抓取並每小時更新，跑滿一輪後「漲跌」與「時間窗內成交量」才會出現數字；在那之前本頁只用目前瀏覽器記錄的本地取樣點（換裝置不共享）。",
  // 使用文檔
  "使用文档": "使用文檔",
  "使用说明书": "使用說明書",
  "开发文档": "開發文檔",
  "AI 上下文": "AI 上下文",
  "CharmTier.basic": "基礎",
  "CharmTier.advanced": "高級",
  "CharmTier.expert": "專家",
  "CharmTier.master": "大師",
  "CharmTier.grandmaster": "宗師",
  ...
  // 補全：新增物品的繁體中文名（原先回落顯示英文）
  "Basic Torch": "基礎火把",
  "Advanced Torch": "高級火把",
  "Expert Torch": "專家火把",
  "Basic Shroud": "基礎帷幔",
  "Advanced Shroud": "高級帷幔",
  "Expert Shroud": "專家帷幔",
  "Basic Beacon": "基礎信標",
  "Advanced Beacon": "高級信標",
  "Expert Beacon": "專家信標",
  "Basic Coffee Crate": "基礎咖啡匣",
  "Advanced Coffee Crate": "高級咖啡匣",
  "Expert Coffee Crate": "專家咖啡匣",
  "Basic Food Crate": "基礎食物匣",
  "Advanced Food Crate": "高級食物匣",
  "Expert Food Crate": "專家食物匣",
  "Basic Tea Crate": "基礎茶葉匣",
  "Advanced Tea Crate": "高級茶葉匣",
  "Expert Tea Crate": "專家茶葉匣",
  "Gatherer Cape": "採集者斗篷",
  "Gatherer Cape (R)": "採集者斗篷（精）",
  "Culinary Cape": "烹飪師斗篷",
  "Culinary Cape (R)": "烹飪師斗篷（精）",
  "Chance Cape": "機運斗篷",
  "Chance Cape (R)": "機運斗篷（精）",
  "Artificer Cape": "工匠大師斗篷",
  "Artificer Cape (R)": "工匠大師斗篷（精）",
  "Pathfinder Boots": "尋路者靴",
  "Pathfinder Boots (R)": "尋路者靴（精）",
  "Pathfinder Lodestone": "尋路者磁石",
  "Pathseeker Boots": "覓徑者靴",
  "Pathseeker Boots (R)": "覓徑者靴（精）",
  "Pathseeker Lodestone": "覓徑者磁石",
  "Pathbreaker Boots": "破徑者靴",
  "Pathbreaker Boots (R)": "破徑者靴（精）",
  "Pathbreaker Lodestone": "破徑者磁石",
  "Labyrinth Essence": "迷宮精华",
  "Labyrinth Token": "迷宮代幣",
  "Labyrinth Refinement Shard": "迷宮精煉碎片",
  "Labyrinth Refinement Chest": "迷宮精煉寶箱",
  "Philosopher's Mirror": "賢者之鏡",
  "Purdora's Box (Combat)": "普多拉寶箱（戰斗）",
  "Purdora's Box (Skilling)": "普多拉寶箱（生活）",
  "Scroll Of Action Speed": "卷軸：行動速度",
  "Scroll Of Attack Speed": "卷軸：攻擊速度",
  "Scroll Of Cast Speed": "卷軸：吟唱速度",
  "Scroll Of Combat Drop": "卷軸：戰斗掉落",
  "Scroll Of Critical Rate": "卷軸：暴擊率",
  "Scroll Of Damage": "卷軸：傷害",
  "Scroll Of Efficiency": "卷軸：效率",
  "Scroll Of Gathering": "卷軸：採集",
  "Scroll Of Gourmet": "卷軸：美食",
  "Scroll Of Processing": "卷軸：加工",
  "Scroll Of Rare Find": "卷軸：稀有發現",
  "Scroll Of Wisdom": "卷軸：經驗",
  // 补全：强化计算的「件数 / 成功期望」输入项缺少悬停说明（2026-09-20）
  "件数提示": "本批要強化的同款裝備件數。每件都從 0 級獨立強化到目標等級，因此材料、保護道具、初始裝備成本以及最終產出都按件數線性放大；表格裡的「材料 / 件」「單個利潤」仍按單件口徑顯示，方便橫向比較不同方案。",
  "成功期望提示": "成功率來自馬可夫鏈算出的「平均需要多少次強化」。但這個平均次數只是期望值，實際手氣往往更差，所以這裡讓你自留餘量：填 1 表示完全按平均期望計算；填 1.2 表示假設要花到 1.2 倍期望次數才成功（即材料與保護道具消耗上浮 20%）；填小於 1 則表示你預計比平均更順。該係數會同時放大強化次數與保護次數，再乘以件數。",
  // 补全：强化计算「工时费 / 溢价率 / 成品售价 / 成交税率」缺少悬停说明
  "工时费说明": "把你自己的時間折算成錢。按「每小時值多少」乘以本次強化佔用的工時，計入總成本。填 0 表示不計算時間成本，只看純材料與裝備開銷。",
  "溢价率说明": "給成本預留的浮動餘量（%）。真實買料時未必總能拿到表裡的最優價，所以這裡按比例上浮整批成本：填 5 表示總成本按 105% 計算，讓利潤估計更保守。注意它作用在總成本上，與下面的成交稅率不是一回事。",
  "成品售价说明": "每件強化到目標等級後的出售單價。留空則自動取當前市場的右收購價（bid）。收入按「單價 × 98% × 件數」計算，其中 2% 是遊戲固定的市場成交稅。",
  "成交税率说明": "遊戲固定的市場成交稅，玩家無法更改：無論掛什麼價，成交後按 2% 扣除。因此這裡只作展示，收入統一按標價的 98% 計入。",
  // 市場監控「分類」下拉的物品分類
  "ability_book": "技能書",
  "currency": "貨幣",
  "drink": "飲品",
  ...
  "每行可分别限定该生产的要求等级区间": "每一行可單獨限定該生產的要求等級區間：不同生產能接受的等級區間往往不同（例如「鍛造 50~80」與「裁縫 20~60」可以同時保留），留空表示該行不限等級。與上方的全域「要求等級」是並列條件，兩者都會生效。",
  // 补全：市场监控各项口径的悬停说明（成交量是当日累计、速率受采样间隔影响）
  "市场监控口径说明": "本頁資料來自官方市場快照。官方給的成交量是「當日累計成交量」（每天 UTC 0 點歸零），直接顯示的話，剛過 UTC 零點所有物品都會變成很小的數字、跨時刻完全不可比。所以本頁的成交量欄改用**時間窗內滾動成交量**：在自有取樣歸檔上把相鄰取樣點的增量滾動累加，不歸零、跨時刻可比。價格漲跌仍以所選時間窗的基準點為準。",
  "成交量速率口径说明": "兩個快照之間的成交量增量 ÷ 實際間隔小時數，反映「最近多熱」，不受 UTC 歸零影響。注意：快照約每小時才更新一次，若所選時間窗比取樣間隔還短，實際會退回用更早的基準點，此時該速率是按那段更長的區間平均出來的（表格上方會給出實際的區間中位數）。",
  "成交量速率区间提示": "目前時間窗為 {1} 小時，但快照間隔較疏，實際是按約 {0} 小時的區間估算的 —— 該欄數值請按此區間理解。",
  // 滚动成交量（时间窗内成交量）
  "时间窗内成交量": "時間窗內成交量",
  "时间窗内": "時間窗內",
  "今日累计": "今日累計",
  "近": "近",
  "滚动成交量说明": "把所選時間窗內**相鄰取樣點的成交量增量**滾動累加，因此不受 UTC 歸零影響，一天當中任何時刻都可比。欄頭寫的是**實際統計區間**（= 現在 − 基準取樣點），與所選時間窗可能不一致：取樣稀疏時實際區間更長，歷史覆蓋不足時更短。跨 UTC 歸零點那一段只能統計到 0 點之後，所以覆蓋率可能不足 100%（表格上方會提示）。它衡量的是「這段時間裡這件東西成交了多少件」。",
  "滚动成交额说明": "時間窗內成交量 × 目前價，同樣是滾動口徑（不受 UTC 歸零影響）。它不是真實成交額：區間內各筆成交的價格並不相同，這裡統一用目前價折算。",
  "滚动成交量覆盖率提示": "滾動成交量有約 {0}% 的區間能精確統計（實際統計區間約 {1} 小時）：跨 UTC 歸零點的那一段（0 點之前的累計量已被官方歸零）無法還原，取樣越密丟失越少。",
  // 物品等级 / 强化等级（市场按强化等级分档报价）
  "物品等级": "物品等級",
  "物品等级说明": "物品自身的等級（推薦等級），同一件裝備的所有強化檔位共用同一個值。",
  "强化等级": "強化等級",
  "未强化": "未強化(+0)",
  "强化等级说明": "官方市場是**按強化等級分檔報價**的：0 表示未強化，N 表示 +N。同一件裝備的每個有報價的檔位都是列表裡的一條獨立記錄，價格與成交量分別統計 —— 例如神聖鑿子在本頁會出現 +0/+2/+3/+4/+5/+6/+7/+8/+10/+11/+12 共 11 條。想只看某幾檔就在這裡多選。",
  // 补全：成交活跃 Top10 的排序口径说明
  "成交活跃 Top10": "成交活躍 Top10",
  "按成交量速率排序": "按成交量速率排序（不受 UTC 歸零影響）",
  "按当日累计成交量排序": "按當日累計成交量排序（歷史未載入時的退化口徑）",
  "监控各物品市场成交量与成交额，成交量按时间窗滚动统计": "監控各物品市場成交量與成交額；成交量按所選時間窗滾動統計（不受 UTC 歸零影響），裝備按強化等級分檔",
}