export default {
  ...
  // 开源公告
  "开源公告": "MewKonomy 现已完全开源！欢迎 Star、Fork 和参与贡献。",
  "关闭": "关闭",

  // 冻结横幅
  "暂停公告": "因违反游戏政策，本站作者及多位朋友的账号已被封禁。MewKonomy 将暂停服务至 11 月 4 日，期间仅保留英灵殿页面，用以纪念那些因各种原因离开游戏的玩家们。暂停期间也希望大家少一点PVP，回归挂机游戏的本质，享受游戏带来的乐趣，更重要的是享受生活。感谢大家一直以来的支持与陪伴。",
  ...
  "单次耗时": "单次耗时",
  "请选择物品": "请选择物品",
  "存在不可用的环节，请检查选择": "存在不可用的环节，请检查选择",
  "计算失败": "计算失败",
  "项目+动作逐节点缀连，自动内部流转并整链核算": "项目+动作逐节点缀连，自动内部流转并整链核算",
  "护符转化盈利": "护符转化盈利",
  "冲泡护符转化盈利": "冲泡护符转化盈利",
  "冲泡精华→冲泡护符→转化，双口径对比理想价格与实际价格": "冲泡精华→冲泡护符→转化，双口径对比理想价格与实际价格",
  "理想价格": "理想价格",
  "实际价格": "实际价格",
  "市场无人买卖时由你主宰，挂价上限=产出护符自身精华直接制作成本": "市场无人买卖时由你主宰，挂价上限=产出护符自身精华直接制作成本",
  "护符档位": "护符档位",
  "所需精华": "所需精华",
  "精华成本": "精华成本",
  "成功率": "成功率",
  ...
  "理想利润率": "理想利润率",
  "提示": "提示",
  "实际价格为当前市场成交价，无流动性护符按0计；理想价格为无市场时按产出护符自身精华直接制作成本挂价，点击行查看产出明细": "实际价格为当前市场成交价，无流动性护符按0计；理想价格为无市场时按产出护符自身精华直接制作成本挂价，点击行查看产出明细",
  "产出明细": "产出明细",
  "转化": "转化",
  "每档10种护符各10%产出": "每档10种护符各10%产出",
  "产出护符": "产出护符",
  "掉率": "掉率",
  "市场买价": "市场买价",
  "实际卖价": "实际卖价",
  ...
  // 市场监控
  "市场监控": "市场监控",
  "监控各物品市场成交量与成交额，按成交量实时排行": "监控各物品市场成交量与成交额，按成交量实时排行",
  "市场物品": "市场物品",
  "有成交": "有成交",
  "成交量最高": "成交量最高",
  "数据时间": "数据时间",
  ...
  "线上历史": "线上历史",
  "最近采样": "最近采样",
  "本地采样已是最新，无需重复记录": "本地采样已是最新，无需重复记录",
  "已记录历史采样点": "已记录历史采样点",
  "正在加载历史分片…": "正在加载历史分片…",
  // 原先只有 en 定义了这个键，中文两种语言下会直接显示键名本身，这里补齐
  "无线上历史提示": "尚未取到线上历史分片（data/market_history_*.json）。归档由 GitHub Actions 抓取并每小时更新，跑满一轮后「涨跌」与「时间窗内成交量」才会出现数字；在那之前本页只用当前浏览器记录的本地采样点（换设备不共享）。",
  // 使用文档
  "使用文档": "使用文档",
  "使用说明书": "使用说明书",
  "开发文档": "开发文档",
  ...
  // 补全：原先只有英文 key、中文界面会回落显示英文的列头
  "Action": "行动",
  "Buff": "增益",
  "Prot": "保护档位",

  // 补全：2026-09-20 新增物品的中文名（原先回落显示英文）
  "Basic Torch": "基础火把",
  "Advanced Torch": "高级火把",
  "Expert Torch": "专家火把",
  "Basic Shroud": "基础帷幔",
  "Advanced Shroud": "高级帷幔",
  "Expert Shroud": "专家帷幔",
  "Basic Beacon": "基础信标",
  "Advanced Beacon": "高级信标",
  "Expert Beacon": "专家信标",
  "Basic Coffee Crate": "基础咖啡匣",
  "Advanced Coffee Crate": "高级咖啡匣",
  "Expert Coffee Crate": "专家咖啡匣",
  "Basic Food Crate": "基础食物匣",
  "Advanced Food Crate": "高级食物匣",
  "Expert Food Crate": "专家食物匣",
  "Basic Tea Crate": "基础茶叶匣",
  "Advanced Tea Crate": "高级茶叶匣",
  "Expert Tea Crate": "专家茶叶匣",
  "Gatherer Cape": "采集者斗篷",
  "Gatherer Cape (R)": "采集者斗篷（精）",
  "Culinary Cape": "烹饪师斗篷",
  "Culinary Cape (R)": "烹饪师斗篷（精）",
  "Chance Cape": "机运斗篷",
  "Chance Cape (R)": "机运斗篷（精）",
  "Artificer Cape": "工匠大师斗篷",
  "Artificer Cape (R)": "工匠大师斗篷（精）",
  "Pathfinder Boots": "寻路者靴",
  "Pathfinder Boots (R)": "寻路者靴（精）",
  "Pathfinder Lodestone": "寻路者磁石",
  "Pathseeker Boots": "觅径者靴",
  "Pathseeker Boots (R)": "觅径者靴（精）",
  "Pathseeker Lodestone": "觅径者磁石",
  "Pathbreaker Boots": "破径者靴",
  "Pathbreaker Boots (R)": "破径者靴（精）",
  "Pathbreaker Lodestone": "破径者磁石",
  ...
  "Purdora's Box (Combat)": "普多拉宝箱（战斗）",
  "Purdora's Box (Skilling)": "普多拉宝箱（生活）",
  "Scroll Of Action Speed": "卷轴：行动速度",
  "Scroll Of Attack Speed": "卷轴：攻击速度",
  "Scroll Of Cast Speed": "卷轴：吟唱速度",
  "Scroll Of Combat Drop": "卷轴：战斗掉落",
  "Scroll Of Critical Rate": "卷轴：暴击率",
  "Scroll Of Damage": "卷轴：伤害",
  "Scroll Of Efficiency": "卷轴：效率",
  "Scroll Of Gathering": "卷轴：采集",
  "Scroll Of Gourmet": "卷轴：美食",
  "Scroll Of Processing": "卷轴：加工",
  "Scroll Of Rare Find": "卷轴：稀有发现",
  "Scroll Of Wisdom": "卷轴：经验",
  // 补全：强化计算的「件数 / 成功期望」输入项缺少悬停说明（2026-09-20）
  "件数提示": "本批要强化的同款装备件数。每件都从 0 级独立强化到目标等级，因此材料、保护道具、初始装备成本以及最终产出都按件数线性放大；表格里的「材料 / 件」「单个利润」仍按单件口径显示，方便横向比较不同方案。",
  "成功期望提示": "成功率来自马尔可夫链算出的「平均需要多少次强化」。但这个平均次数只是期望值，实际手气往往更差，所以这里让你自留余量：填 1 表示完全按平均期望计算；填 1.2 表示假设要花到 1.2 倍期望次数才成功（即材料与保护道具消耗上浮 20%）；填小于 1 则表示你预计比平均更顺。该系数会同时放大强化次数与保护次数，再乘以件数。",
  // 补全：强化计算「工时费 / 溢价率 / 成品售价 / 成交税率」缺少悬停说明
  "工时费说明": "把你自己的时间折算成钱。按「每小时值多少」乘以本次强化占用的工时，计入总成本。填 0 表示不计算时间成本，只看纯材料与装备开销。",
  "溢价率说明": "给成本预留的浮动余量（%）。真实买料时未必总能拿到表里的最优价，所以这里按比例上浮整批成本：填 5 表示总成本按 105% 计算，让利润估计更保守。注意它作用在总成本上，与下面的成交税率不是一回事。",
  "成品售价说明": "每件强化到目标等级后的出售单价。留空则自动取当前市场的右收购价（bid）。收入按「单价 × 98% × 件数」计算，其中 2% 是游戏固定的市场成交税。",
  "成交税率说明": "游戏固定的市场成交税，玩家无法更改：无论挂什么价，成交后按 2% 扣除。因此这里只作展示，收入统一按标价的 98% 计入。",
  // 市场监控「分类」下拉的物品分类（key 为 game data 的 categoryHrid 末段）
  "ability_book": "技能书",
  "currency": "货币",
  "drink": "饮品",
  "dungeon_key": "地牢钥匙",
  ...
  "每行可分别限定该生产的要求等级区间": "每一行可单独限定该生产的要求等级区间：不同生产能接受的等级区间往往不同（例如「锻造 50~80」与「裁缝 20~60」可以同时保留），留空表示该行不限等级。与上方的全局「要求等级」是并列条件，两者都会生效。",
  // 补全：市场监控各项口径的悬停说明（成交量是当日累计、速率受采样间隔影响）
  "市场监控口径说明": "本页数据来自官方市场快照。官方给的成交量是「当日累计成交量」（每天 UTC 0 点归零），直接展示它的话，刚过 UTC 零点所有物品都会变成很小的数字、跨时刻完全不可比。所以本页的成交量列改用**时间窗内滚动成交量**：在自有采样归档上把相邻采样点的增量滚动累加，不归零、跨时刻可比。价格涨跌仍以所选时间窗的基准点为准。",
  "成交量速率口径说明": "两个快照之间的成交量增量 ÷ 实际间隔小时数，反映\"最近多热\"，不受 UTC 归零影响。注意：快照约每小时才更新一次，若所选时间窗比采样间隔还短，实际会退回用更早的基准点，此时该速率是按那段更长的区间平均出来的（表格上方会给出实际的区间中位数）。",
  "成交量速率区间提示": "当前时间窗为 {1} 小时，但快照间隔较疏，实际是按约 {0} 小时的区间估算的 —— 该列数值请按此区间理解。",
  // 滚动成交量（时间窗内成交量）
  "时间窗内成交量": "时间窗内成交量",
  "时间窗内": "时间窗内",
  "今日累计": "今日累计",
  "近": "近",
  "滚动成交量说明": "把所选时间窗内**相邻采样点的成交量增量**滚动累加，因此不受 UTC 归零影响，一天当中任何时刻都可比。列头写的是**实际统计区间**（= 现在 − 基准采样点），与所选时间窗可能不一致：采样稀疏时实际区间更长，历史覆盖不足时更短。跨 UTC 归零点那一段只能统计到 0 点之后，所以覆盖率可能不足 100%（表格上方会提示）。它衡量的是「这段时间里这件东西成交了多少件」。",
  "滚动成交额说明": "时间窗内成交量 × 当前价，同样是滚动口径（不受 UTC 归零影响）。它不是真实成交额：区间内各笔成交的价格并不相同，这里统一用当前价折算。",
  "滚动成交量覆盖率提示": "滚动成交量有约 {0}% 的区间能精确统计（实际统计区间约 {1} 小时）：跨 UTC 归零点的那一段（0 点之前的累计量已被官方归零）无法还原，采样越密丢失越少。",
  // 物品等级 / 强化等级（市场按强化等级分档报价）
  "物品等级": "物品等级",
  "物品等级说明": "物品自身的等级（推荐等级），同一件装备的所有强化档位共用同一个值。",
  "强化等级": "强化等级",
  "未强化": "未强化(+0)",
  "强化等级说明": "官方市场是**按强化等级分档报价**的：0 表示未强化，N 表示 +N。同一件装备的每个有报价的档位都是列表里的一条独立记录，价格与成交量分别统计 —— 例如神圣凿子在本页会出现 +0/+2/+3/+4/+5/+6/+7/+8/+10/+11/+12 共 11 条。想只看某几档就在这里多选。",
  // 补全：成交活跃 Top10 的排序口径说明
  "成交活跃 Top10": "成交活跃 Top10",
  "按成交量速率排序": "按成交量速率排序（不受 UTC 归零影响）",
  "按当日累计成交量排序": "按当日累计成交量排序（历史未加载时的退化口径）",
  "监控各物品市场成交量与成交额，成交量按时间窗滚动统计": "监控各物品市场成交量与成交额；成交量按所选时间窗滚动统计（不受 UTC 归零影响），装备按强化等级分档",
}