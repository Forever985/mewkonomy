...
const panelFields: PanelField[] = [
  ...
  { type: "range", label: "售价", labelSuffix: " ≤", minKey: "minSellPrice", maxKey: "maxSellPrice", width: 80, unit: "M", placeholderMin: "0", placeholderMax: "∞" },
  ...
  { type: "checkbox", key: "bestManufacture", label: "最佳制作方案" }
]
