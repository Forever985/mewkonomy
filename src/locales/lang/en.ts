export default {
  ...
  "理想价格": "Ideal Price",
  "实际价格": "Actual Price",
  "市场无人买卖时由你主宰，挂价上限=精华直接制作成本": "When nobody trades it, you own the market; cap = essence selfcraft cost",
  "护符档位": "Charm Tier",
  "所需精华": "Essence Req.",
  "精华成本": "Essence Cost",
  ...
  "理想利润率": "Ideal Margin",
  "提示": "Note",
  "实际价格为当前市场成交价，无流动性护符按0计；理想价格为无市场时按精华直接制作成本挂价，点击行查看产出明细": "Actual uses current market price (no-liquidity charms counted as 0); ideal prices no-liquidity charms at essence selfcraft cost. Click a row for detail.",
  "产出明细": "Output Detail",
